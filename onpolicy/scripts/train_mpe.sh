...
# --env_name "MPE" --algorithm_name "rmappo" --experiment_name "rnn_mini4" --scenario_name "simple_spread" --num_agents 6 --num_landmarks 6 --seed 50 --n_training_threads 127 --n_rollout_threads 128 --num_mini_batch 1 --episode_length 25 --num_env_steps 2000000 --ppo_epoch 10 --gain 0.01 --lr 7e-4 --critic_lr 7e-4 --use_wandb