...
class MPERunner(Runner):
    ...
    def run(self):
        ...
        for episode in range(episodes):
            ...
            for step in range(self.episode_length):
                # Sample actions
                values, actions, action_log_probs, rnn_states, rnn_states_critic, actions_env, father_actions = self.collect(step)  ## (1,4,1)*3, (1,4,1,64)*2, (1,4,5)
    ...
    def insert(self, data):
        ...
        self.buffer.insert(share_obs, obs, rnn_states, rnn_states_critic, actions, action_log_probs, values, rewards, masks, father_actions)
