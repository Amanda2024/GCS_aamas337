...
class GuassianSqueeze(gym.Env):  # Gaussian Squeeze
    def __init__(self, agents, episode_limit):
        ...
        self.action_space = spaces.MultiDiscrete([self.action_dim]*self.agents)
    ...
    def step(self, action):
        ...
        info['score_reward'] = reward_1
        return self.state[0], [reward_1]*self.agents, done[0], info
    ...
    def action_space(self):
        return spaces.MultiDiscrete([self.action_dim]*self.agents)
