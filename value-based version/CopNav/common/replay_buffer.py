...
class ReplayBuffer:
    def __init__(self, args):
        ...
        self.buffers = {'o': np.empty([self.size, self.episode_limit, self.n_agents, self.obs_shape]),
                        ...
                        'father_actions': np.empty([self.size, self.episode_limit, self.n_agents, self.n_agents * self.n_actions]),
                        'father_actions_next': np.empty([self.size, self.episode_limit, self.n_agents, self.n_agents * self.n_actions])
                        }
